...
```js
var sequelize = new Sequelize(
  "postgres://username:password@host.com:5432/dbname"
);
```
...
[공식도큐먼트](http://docs.sequelizejs.com/en/latest/docs/models-definition)
에서 확인할 수 있다.\*\*
...
[bluebird API reference](http://bluebirdjs.com/docs/api-reference.html)에 나와있다.
