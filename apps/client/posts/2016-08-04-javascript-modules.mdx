...
**FreeCodeCamp에 기재된 [Preethi Kasireddy의 포스트](https://medium.freecodecamp.com/javascript-modules-a-beginner-s-guide-783f7d7a5fcc#.wou8etvsd)를 번역한 글입니다. 이해한대로 의역했기 때문에 오역 및 빠뜨리는 부분이 있을 수 있습니다.**
...
관련 없는 코드간의 전역변수 공유는 매우 좋지 않습니다. [big no-no!!](http://c2.com/cgi/wiki?GlobalVariablesAreBad)
...
[Learning JavaScript Design Patterns](https://addyosmani.com/resources/essentialjsdesignpatterns/book/#modulepatternjavascript) by Addy Osmani: 인상적인 간결함 속에서 보물을 발견할 수 있음

[Adequately Good by Ben Cherry](http://www.adequatelygood.com/JavaScript-Module-Pattern-In-Depth.html) 모듈패턴에 익숙한 사람들을 위해 예제를 포함한 유용한 개요

[Blog of Carl Danley](https://carldanley.com/js-module-pattern/) 모듈패턴의 개요 및 다른 자바스크립트 패턴들의 리소스
...
더 많은 UMD의 형식을 보고싶다면 [이 곳](https://github.com/umdjs/umd)을 참조하세요.
