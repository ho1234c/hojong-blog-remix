...
[[더 자세한 내용]](http://www.nextree.co.kr/p7292/)
...
[const](const) 와 [arrow function](https://github.com/lukehoban/es6features#arrows)인데, 링크에서 예시와 함께 설명이 잘 나와있다.
...
end 메소드는 response header와 body가 모두 보내졌다는 신호이다. 관련 메소드에 대해서는 [공식 api](https://nodejs.org/docs/latest/api/http.html#http_response_end_data_encoding_callback)에 자세히 나와 있다.
